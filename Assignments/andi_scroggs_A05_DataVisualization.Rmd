...
#cowplot?
combined_plot <- NTL_LTER_processed_Chem_nutr %>%
...
> Answer: There are temperature increases in the summer months and decreases in the winter months across both lakes. The Peter Lake has higher averages of TN and TP, but a lower average temperature compared to Paul Lake. 

...
```{r monthly ozone 2018, echo=FALSE, fig.cap='Monthly Ozone Concentration in 2018'}
...
ozone2018 <- epa_data %>%
  ...
  ggtitle("Monthly Ozone Concentration in 2018")
  
  
print(ozone2018)
```

```{r monthly ozone 2019, echo=FALSE}
...
ozone2019 <- epa_data %>%
  ...
  xlab("Month") +
  ylab("Concentration (µg/m3)") +
  labs("Monthly Ozone Concentrationin 2019")

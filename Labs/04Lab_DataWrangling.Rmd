...
> Add notes here: 
vignette('dplyr') - give information on the package; explains the bigger picture
cheat sheets - helpful as well; through help button at the top
...
# Choose a range of conditions of a numeric or integer variable - a colon means between
...
NTL.phys.data.TL <- filter(NTL.phys.data, lakename == "Tuesday Lake",
                           year4 %in% 1990:1999)
...
NTL.phys.data.TL.Jul90.99 <- NTL.phys.data %>%
  mutate(month = month(NTL.phys.data$sampledate)) %>%

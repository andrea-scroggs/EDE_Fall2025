...
mapview(huc8_sf, col.regions = 'grey') +
  mapview(upper_neuse_sf, 
          col.regions = 'yellow', 
          color = 'blue')
#OR

ggplot() +
  geom_sf(data = huc8_sf, color = 'grey') +
  geom_sf(data = upper_neuse_sf, 
          color = 'blue', 
          fill = 'yellow')
```

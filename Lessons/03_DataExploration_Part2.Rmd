...
>Answer: It is important to explore your dataset so that you have context to what you are looking at and analyzing. I think the overall point of data analysis is to use data to convey and support findings and results of research questions. In order to do that you need to understand what your data stands for and what it means, otherwise they are just numbers without meaning.
...
ggplot(USGS.flow.data) +
  ...
  geom_freqpoly(aes(x = gage.height.min), bins = 50, color = "green") +
